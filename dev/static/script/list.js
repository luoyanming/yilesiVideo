...
var VIDEO = {
    ...
    setDate: function(time) {
        ...
        $.ajax({
            url: CONFIG.api + '/parent/ajax/courseRecord/validDate/by/macNo',
            dataType: 'json',
            type: 'post',
            data: {
    ...
    getVideoList: function(time) {
        ...
        $.ajax({
            url: CONFIG.api + '/parent/ajax/courseRecord/list/by/macNo',
            dataType: 'json',
            type: 'post',
            data: {
                macNo: that.getQueryString('macNo'),
            ...
            success: function(res) {
                if (res.code == 0) {
                    ...
                    for (var i = 0; i < list.length; i++) {
                        ...
                        temp += '<a href="./listdetail.html?macNo=' + that.getQueryString('macNo') + '&recordId=' + list[i].recordId + '" class="flex-h">';
